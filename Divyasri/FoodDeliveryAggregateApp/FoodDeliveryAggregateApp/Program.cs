...
namespace FoodDeliveryAggregateApp
{
    class Program
    {
        ...
        static void AddRestaurant()
        {
            ...
            if (bal.AddRestaurantByAdmin(restaurant))
            {
        ...
        static void ViewRestaurants()
        {
            Console.WriteLine("Enter Location:");
            string location = Console.ReadLine();
            List<RestaurantDTO> restaurants = bal.GetRestaurantsByLocation(location);
        ...
        static void UpdateOrderStatus()
        {
            Console.WriteLine("Enter Order Id:");
            long orderId = long.Parse(Console.ReadLine());
            Console.WriteLine("Enter New Status (e.g., Delivered):");
            string status = Console.ReadLine();

            if (bal.UpdateOrderStatus(orderId, status))
            {
                Console.WriteLine("Order Status Updated Successfully");
            }
            else
            {
                Console.WriteLine("Order Status Not Updated");
            }
        }
    }
}
