...
public class DataAccessLayer
{
    ...
    public bool DeleteUser(int userId)
    {
        ...
        {
            Console.WriteLine($"Debug: Exception in DataAccessLayer.DeleteUser: {ex.Message}");
            return false;
        }
        finally
        {
    ...
    public bool UpdateUser(UserDTO user)
    {
        try
        {
            string query = "UPDATE Users SET Name = @Name, Email = @Email, Password = @Password, RoleName = @RoleName, Location = @Location WHERE UserId = @UserId";
            using (SqlCommand cmd = new SqlCommand(query, con))
            {
        ...
        {
            Console.WriteLine($"Debug: Exception in DataAccessLayer.UpdateUser: {ex.Message}");
            return false;
        }
    }
    ...
    public RestaurantDTO GetRestaurantById(int id)
    {
        ...
        string query = "SELECT * FROM Restaurants WHERE RID = @RID";
        using (SqlCommand cmd = new SqlCommand(query, con))
        {
    ...
    public bool UpdateRestaurant(RestaurantDTO restaurant)
    {
        try
        {
            string query = "UPDATE Restaurants SET Name = @Name, Location = @Location, OwnerId = @OwnerId WHERE RID = @RID";
            using (SqlCommand cmd = new SqlCommand(query, con))
            {
                cmd.Parameters.AddWithValue("@RID", restaurant.RID);
                cmd.Parameters.AddWithValue("@Name", restaurant.Name);
                cmd.Parameters.AddWithValue("@Location", restaurant.Location);
                cmd.Parameters.AddWithValue("@OwnerId", restaurant.OwnerId);
                con.Open();
        ...
        {
            Console.WriteLine($"Debug: Exception in DataAccessLayer.UpdateRestaurant: {ex.Message}");
            return false;
        }
    }
    ...
    {
        using (SqlCommand cmd = new SqlCommand("DELETE FROM Restaurants WHERE RestaurantId = @Id", con))
        {
