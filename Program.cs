...
namespace FoodDelApp
{
    internal class Program
    {
        ...
        private static void SearchRestaurantsByLocation()
        {
            ...
            {
                Console.WriteLine($"Restaurant Id: {restaurant.RId}, Name: {restaurant.Name}, Location: {restaurant.Location}, Owner Id: {restaurant.UserId}");
            }
        }
        ...
        private static void FilterMenuItems()
        {
            ...
            {
                Console.WriteLine($"Restaurant Id: {menuItem.RestaurantId}, Menu Name: {menuItem.MenuName}, Price: {menuItem.Price}, Category: {menuItem.Category}");
            }
        }
